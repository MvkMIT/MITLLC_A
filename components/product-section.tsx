...
const products = [
  {
    ...
    description: "Strategic staffing solutions to help you find the right talent for your technology needs.",
    image: "/Team.jpg",
    tag: "Staffing",
  },
  {
    name: "Staff Augmentation",
    description: "Flexible team scaling with skilled professionals ready to integrate into your projects.",
    image: "/leadership/prasad_ceo.png",
    tag: "Consulting",
  },
  {
    name: "Digital Transformation",
    description: "End-to-end technology solutions that modernize operations and drive business growth.",
    image: "/logo.png",
    tag: "Technology",
  },
]
